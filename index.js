document.addEventListener('DOMContentLoaded', () => {
  ...
  // Move these functions to outer scope
    ...
    .then(values => {
      ...
      document.querySelectorAll(".buy-now-btn").forEach(button => {
        button.addEventListener('click', function () {
          ...
          const productToAdd = values[productId]; // Use the correct index directly here
  ...
  fetch("discounts.json")
    ...
    .then(discounts => {
      ...
      document.querySelectorAll(".discount-cards .buy-now-btn").forEach(button => {
        button.addEventListener('click', function () {
          const productId = this.getAttribute("data-product-id");
          const productToAdd = discounts[productId]; // Use the correct discount here
          addToCart(productToAdd);
          alert(`${productToAdd.name} added to cart!`);
        });
      });
